...
#	@$(call install_alternative, iptables, 0, 0, 0644, /config/etc/iptables/rules.v6)
	@$(call install_copy, iptables, 0, 0, 0644, $(PTXDIST_TOPDIR)/projectroot/etc/iptables/rules.v6, /config/etc/iptables/rules.v6)
	@$(call install_link, iptables, /config/etc/iptables, /etc/iptables)
...
#	@$(call install_alternative, iptables, 0, 0, 0644, /config/etc/iptables/rules.v4)
	@$(call install_copy, iptables, 0, 0, 0644, $(PTXDIST_TOPDIR)/projectroot/etc/iptables/rules.v4, /config/etc/iptables/rules.v4)
	@$(call install_link, iptables, /config/etc/iptables, /etc/iptables)
