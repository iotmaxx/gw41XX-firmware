...
PYTHON3_ATTRS_URL	:= https://files.pythonhosted.org/packages/98/c3/2c227e66b5e896e15ccdae2e00bbc69aa46e9a8ce8869cc5fa96310bf612/$(PYTHON3_ATTRS).$(PYTHON3_ATTRS_SUFFIX)
...
$(STATEDIR)/python3-attrs.prepare:
	@$(call targetinfo)
	@$(call world/prepare, PYTHON3_ATTRS)
	@echo -e '[DEFAULT]\nlibrary_dirs =\ninclude_dirs =' > $(PYTHON3_ATTRS_DIR)/site.cfg
	@$(call touch)
...
$(STATEDIR)/python3-attrs.targetinstall:
	...
	@$(call install_fixup, python3-attrs, AUTHOR, "Niklas Sill <sill@iotmaxx.de>")
	@$(call install_fixup, python3-attrs, DESCRIPTION, missing)

		@$(call install_glob, python3-attrs, 0, 0, -, \
		/usr/lib/python$(PYTHON3_MAJORMINOR)/site-packages/attr,,  *.py)
