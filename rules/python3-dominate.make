...
# Paths and names
#
PYTHON3_DOMINATE_VERSION	:= 2.9.1
PYTHON3_DOMINATE_MD5		:= 4dc4bbb39297999624e2312b6fe2b46f
PYTHON3_DOMINATE		:= dominate-$(PYTHON3_DOMINATE_VERSION)
PYTHON3_DOMINATE_SUFFIX		:= tar.gz
PYTHON3_DOMINATE_URL		:= $(call ptx/mirror-pypi, dominate, $(PYTHON3_DOMINATE).$(PYTHON3_DOMINATE_SUFFIX))
#https://files.pythonhosted.org/packages/29/23/edf8e470f1053245c1aa99d92c8a3da9e83f6c7d3eb39205486965425be5/$(PYTHON3_DOMINATE).$(PYTHON3_DOMINATE_SUFFIX)
