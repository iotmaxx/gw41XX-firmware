...
# Paths and names
#
PYTHON3_GW_WATCHDOG_VERSION	:= 0.1.7
PYTHON3_GW_WATCHDOG_MD5		:= 14c5696aa71b637c05dbff84eb9152ea
PYTHON3_GW_WATCHDOG		:= gw-watchdog-$(PYTHON3_GW_WATCHDOG_VERSION)
PYTHON3_GW_WATCHDOG_SUFFIX	:= tar.gz
PYTHON3_GW_WATCHDOG_URL		:=  https://api.github.com/repos/iotmaxx/gw-watchdog/tarball/$(PYTHON3_GW_WATCHDOG_VERSION)
#https://github.com/iotmaxx/gw-watchdog/archive/$(PYTHON3_GW_WATCHDOG_VERSION)/$(PYTHON3_GW_WATCHDOG).$(PYTHON3_GW_WATCHDOG_SUFFIX)
